...
CFLAGS      = -O2 -Wall -Wno-missing-braces -I$(RAYLIB)/include -I.
...
TEST_CFLAGS  = -O0 -g -Wall -Wno-missing-braces -I.
...
$(TEST_TARGET): $(TEST_SRC) app_data.h db.h score_logic.h struct_table.h $(SQLITE_OBJ)
	@mkdir -p bin
